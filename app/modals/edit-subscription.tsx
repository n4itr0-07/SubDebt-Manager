...
const categories = ['Entertainment','Productivity','Utilities','Gaming','Health & Fitness','News & Reading','Other'];
...
const styles = StyleSheet.create({
  ...
  chip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, backgroundColor: 'rgba(255,255,255,0.05)', borderWidth: 0.5, borderColor: 'rgba(255,255,255,0.08)' },
